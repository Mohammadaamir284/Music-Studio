...
async function aamir(folder) {
   ...
   // let a = await fetch(`http://127.0.0.1:3000/${folder}/`)
    let a = await fetch(`https://github.com/Mohammadaamir284/Music-Studio/tree/gh-pages/${folder}/`)
...
async function aamir2() {
   // let a = await fetch(`http://127.0.0.1:3000/maamir/`)
    let a = await fetch(`https://github.com/Mohammadaamir284/Music-Studio/tree/gh-pages/maamir/`)
    let response = await a.text();
    let div = document.createElement("div")
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/maamir")) {
          ...
          //  let a = await fetch(`http://127.0.0.1:3000/maamir/${folder}/info.json`)
            let a = await fetch(`https://github.com/Mohammadaamir284/Music-Studio/tree/gh-pages/${folder}/info.json`)
